...
<table width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td>بيانات أساسية عالية الجودة، تم تصنيفها ومراجعتها يدوياً لتأسيس خط الأساس.</td>
      <td align="center">-</td>
      <td align="center">-</td>
    </tr>
    <tr>
      ...
      <td>دمج الذهبية مع بيانات فضية (Silver Data) استخرجها النموذج الأول بثقة > 75%. تم استبعاد <b>~18%</b> من التصنيفات الأولية لضمان جودة البيانات.</td>
...
لضمان الشفافية وتجنب تحيز النموذج لصالح الفئات الأكثر شيوعاً، تم قياس أداء النموذج على كل فئة على حدة:

| الفئة (Category) | الدقة (Precision) | الاستدعاء (Recall) | دقة F1 |
| :--- | :---: | :---: | :---: |
| 🏛️ سياسة (Politics) | 0.86 | 0.84 | **0.85** |
| 📈 اقتصاد (Economy) | 0.82 | 0.79 | **0.80** |
| ⚽ رياضة (Sports) | 0.91 | 0.93 | **0.92** |
| 💻 تكنولوجيا (Tech) | 0.78 | 0.76 | **0.77** |
| 🩺 صحة (Health) | 0.80 | 0.81 | **0.80** |
...
> 💡 **رؤية هندسية: لماذا تم الاعتماد على مقياس `F1-Macro` تحديداً؟**

<div align="right" dir="rtl">

في سياق الأخبار، غالباً ما تكون الفئات غير متوازنة (Imbalanced Classes)؛ حيث تفوق الأخبار السياسية أو الرياضية غيرها بكثير. الاعتماد على `F1-Macro` (وليس `Micro` أو `Weighted`) يضمن **تقييماً عادلاً** للنموذج، حيث يُحسب المتوسط الحسابي البسيط لأداء جميع الفئات دون أن تتفوق الفئات الأكبر حجماً على نتائج الفئات الأصغر. هذا يمنحنا ثقة بأن النموذج يفهم جميع المجالات الإخبارية، وليس فقط الأكثر شيوعاً.
